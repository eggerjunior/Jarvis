...
- `screenshots/carplay-refocus-after-settings-2026-07-13.png` — 2026-07-13, CarPlay Simulator after settings refocus. Confirms the simulator can be opened locally, but CarPlay validation still depends on a connected physical device and entitlement approval.
...
- Fully granted auto-listening state after permission approval should be captured during the next simulator/device QA pass.
